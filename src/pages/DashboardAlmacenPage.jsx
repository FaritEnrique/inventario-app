...
function SectionCard({ title, description, actionTo, actionLabel, children }) {
  return (
    ...
    <section className="space-y-6">
        ...
        <div className="relative z-10 grid gap-6 lg:grid-cols-[1.4fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-indigo-100 sm:text-base">
              ...
              ingreso/salida, recepción de Órdenes de Compra y movimientos
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <DashboardMetricCard
          ...
          description="Órdenes de Compra aprobadas pendientes o parciales de recepción."
                    ...
                    >
                      <div>
                        ...
                        <p className="mt-1 text-xs text-slate-500">
                          Actual: {formatNumber(row.totalActual)} · Reservado:{" "}
